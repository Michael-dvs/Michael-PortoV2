...
const MediaItem = ({ item, className, onClick }: { item: MediaItemType, className?: string, onClick?: () => void }) => {
    ...
    return (
        <div className="relative w-full h-full overflow-hidden bg-gray-100 dark:bg-zinc-900">
            {!isImgLoaded && (
                <div className="absolute inset-0 bg-gray-200 dark:bg-zinc-900/80 animate-pulse flex items-center justify-center">
                    <div className="w-5 h-5 rounded-full border border-gray-300 dark:border-zinc-850 opacity-20 animate-ping" />
                </div>
            )}
            <img
                ...
                className={`${className} object-cover cursor-pointer transition-opacity duration-300 ${isImgLoaded ? 'opacity-100' : 'opacity-0'}`} // Style the image
        ...
        <>
            ...
            >
                ...
                <div className="h-full flex flex-col">
                    <div className="flex-1 p-2 sm:p-3 md:p-4 flex items-center justify-center bg-gray-50/50 dark:bg-zinc-900/50">
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                onClick={onClose}
                            >
                                <MediaItem item={selectedItem} className="w-full h-full object-contain bg-gray-905/20" onClick={onClose} />
            ...
            >
                <motion.div
                    className="relative rounded-xl bg-[#0066cc]/20 backdrop-blur-xl 
                             border border-[#0066cc]/30 shadow-lg
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="mb-8 text-center">
                <motion.h1
                    className="text-2xl sm:text-3xl md:text-3xl font-semibold text-gray-900 dark:text-white"
